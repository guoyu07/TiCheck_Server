...
nnoremap <silent> <SNR>18_QAToolsToggle :call phpqa#QAToolsToggle()
nnoremap <silent> <SNR>18_CodeCoverageToggle :call phpqa#CodeCoverageToggle()
...
silent only
cd /Library/WebServer/Documents/TiCheck_Server
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 protected/modules/Contact/controllers/AddController.php
badd +0 /Library/WebServer/Documents/test/post.php
args protected
edit [File\ List]
...
exe '1resize ' . ((&lines * 52 + 29) / 59)
exe 'vert 1resize ' . ((&columns * 30 + 119) / 238)
exe '2resize ' . ((&lines * 3 + 29) / 59)
...
wincmd w
argglobal
edit protected/modules/Contact/controllers/AddController.php
...
1
normal! 01l
lcd /Library/WebServer/Documents/TiCheck_Server
wincmd w
argglobal
edit /Library/WebServer/Documents/test/post.php
onoremap <buffer> <silent> [[ ?\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)?:nohls
nnoremap <buffer> <silent> [[ ?\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)?:nohls
onoremap <buffer> <silent> ]] /\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)/:nohls
nnoremap <buffer> <silent> ]] /\(.*\%#\)\@!\_^\s*\zs\(\(abstract\s\+\|final\s\+\|private\s\+\|protected\s\+\|public\s\+\|static\s\+\)*function\|\(abstract\s\+\|final\s\+\)*class\|interface\)/:nohls
